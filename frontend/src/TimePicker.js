...
class TimePicker extends React.Component {
  constructor(props) {
    ...
    let { hours, minutes, seconds } = toHoursMinutesSeconds(
      props.initialValueSeconds
    );
    this.state = {
      seconds: seconds,
      minutes: minutes,
  ...
  onSecondsChanged(event) {
    ...
    this.props?.callback(
      toSeconds(this.state.hours, this.state.minutes, seconds)
    );
  }
  ...
  onMinutesChanged(event) {
    ...
    this.props?.callback(
      toSeconds(this.state.hours, minutes, this.state.seconds)
    );
  }
  ...
  onHoursChanged(event) {
    ...
    this.props?.callback(
      toSeconds(hours, this.state.minutes, this.state.seconds)
    );
  }
